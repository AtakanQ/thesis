...
features = ox.features.features_from_bbox(lat1, lat2, lon1, lon2, {'highway': 'tertiary'}) #Germany turn
road_tuples = [ ]
road_counter = 0
...
for k in range(len(road_tuples)):
    ...
    csv_file = folder_name +"\\" + str(features['source'].index[k][1]) +  '___'+ str(k) + '.csv'
