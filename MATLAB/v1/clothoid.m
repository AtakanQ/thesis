classdef clothoid < handle
   ...
   methods
       ...
       function generateArcSegments(obj)
           ...
           obj.arcX = zeros(obj.order+1,100);
           obj.arcY = zeros(obj.order+1,100);
           ...
           obj.allX = zeros(1,(obj.order+1)*100);
           obj.allY = zeros(1,(obj.order+1)*100);
           for j = 1:(obj.order + 1)

                obj.allX( ((j-1)*100+1):(j*100) )  = obj.arcX(j,:);
                obj.allY( ((j-1)*100+1):(j*100) ) = obj.arcY(j,:);
