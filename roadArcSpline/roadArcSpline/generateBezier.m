...
%     
%     dx_dt = -5*(1-t).^4*P0(1) + 5*(1-t).^4*P1(1) - 20*t.*(1-t).^3*P1(1) + ...
%         20*t.*(1-t).^3*P2(1) + 20*t.^2.*(1-t).^2*P2(1) - 20*t.^2.*(1-t).^2*P3(1) + ...
%         20*t.^3.*(1-t)*P3(1) - 20*t.^3.*(1-t)*P4(1) - 5*t.^4*P4(1) + 5*t.^4*P5(1);
%     
...
%     
%     dy_dt = -5*(1-t).^4*P0(2) + 5*(1-t).^4*P1(2) - 20*t.*(1-t).^3*P1(2) + ...
%         20*t.*(1-t).^3*P2(2) + 20*t.^2.*(1-t).^2*P2(2) - 20*t.^2.*(1-t).^2*P3(2) + ...
%         20*t.^3.*(1-t)*P3(2) - 20*t.^3.*(1-t)*P4(2) - 5*t.^4*P4(2) + 5*t.^4*P5(2);
...
%     
%     d2x_dt2 = 20*(1-t).^3*(P2(1) - 2*P1(1) + P0(1)) + 60*(1-t).^2.*t(P3(1) - 2*P2(1) + P1(1)) ...
%             + 60*(1-t).*t.^2*(P4(1) - 2*P3(1) + P2(1)) + 20*t.^3*(P5(1) - 2*P4(1) + P3(1));
%     
...
%     
%     d2y_dt2 = 20*(1-t).^3*(P2(2) - 2*P1(2) + P0(2)) + 60*(1-t).^2.*t*(P3(2) - 2*P2(2) + P1(2)) ...
%             + 60*(1-t).*t.^2*(P4(2) - 2*P3(2) + P2(2)) + 20*t.^3*(P5(2) - 2*P4(2) + P3(2));
    % Calculate curvature
